...
mailbox_limit = ${PCS_APRS_AGENT_MAILBOX_LIMIT}
gpsd_host = 127.0.0.1
...
outbound_retry_seconds = ${PCS_APRS_AGENT_OUTBOUND_RETRY_SECONDS}
outbound_max_pending = ${PCS_APRS_AGENT_OUTBOUND_MAX_PENDING}
outbound_retention_seconds = ${PCS_APRS_AGENT_OUTBOUND_RETENTION_SECONDS}
EOF
}
