...
```text
scripts/setup-pcs-base.sh              Full baseline setup
scripts/pcs-self-test.sh               Pi-side validation test
scripts/pcs-status.sh                  Detailed system status
scripts/setup-usb-primary-share.sh     Configure USB primary Samba share
scripts/sync-pcs-share-to-backup.sh    Sync USB share to SD backup
scripts/setup-pcs-control-panel.sh     Install PCS web control panel
scripts/setup-dashboard-redirect.sh    Install port 80 dashboard redirect
```

## Documentation

```text
docs/network-topology.md       Network layout and AP mode notes
docs/samba-file-share.md       USB primary share and SD backup mirror
docs/pcs-control-panel.md      Web dashboard and control panel
